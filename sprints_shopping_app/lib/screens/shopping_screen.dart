...
import 'package:sprints_shopping_app/widgets/interactive_card.dart';
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        product["price"]!,
                                        style: const TextStyle(fontSize: 16, color: Color(0xFF934C26)),
                                      ),
                                      IconButton(
                                        icon: const Icon(
                                          Icons.add_shopping_cart_rounded,
                                          color: Color.fromARGB(255, 111, 54, 23),
                                        ),
                                        onPressed: () {
                                              ...
                                              content: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      loc.shopping_itemAdded_detail(product["title"]!),
                                                      style: const TextStyle(
                          ...
                          return Padding(
                            ...
                            child: InteractiveCard(
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  offer["subtitle"]!,
                                  style: const TextStyle(color: Color(0xFF934C26)),
                                ),
                                trailing: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                  decoration: BoxDecoration(
                                    gradient: const LinearGradient(
                                      colors: [Color.fromARGB(255, 111, 54, 23), Color(0xFF934C26)],
                                    ),
